...
def plot_surface_code_heatmap_layout(
    ...
    if len(data_positions) >= 2:
        ...
        lattice_spacing = 2.0
    block_size = 0.6 * lattice_spacing
...
def visualize_syndrome_heatmap_for_round(
    ...
    round_idx: int,
    title_prefix: str = "Syndrome heatmap",
    cmap_name: str = "viridis",
):
    """
    ...
    title = f"{title_prefix} (round {round_idx})"
...
def main():
    ...
    round_values = list(range(2, 20,2 ))
    ...
    for num_round in round_values:
        ...
        for r in range(num_round):
            visualize_syndrome_heatmap_for_round(
                ...
                round_idx=r,
                title_prefix="Rotated surface code : averaged syndromes",
                cmap_name="viridis",  # or "plasma", "magma", etc.
            )
